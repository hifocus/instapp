...
if (/zh-CN|zh-cn|zh-Hans|zh-hans|cn/i.test(userLang)) {
    ...
    document.getElementById("footer").innerHTML = "版本: " + "<span class='grey'>" + version +"</span> | 开源于 <a class='tooltip'id='dont' href='https://github.com/hifocus/adl'>GitHub</a>";
    ...
    document.getElementById("footer").innerHTML = "版本: " + "<span class='grey'>" + version +"</span> |  開源於 <a class='tooltip'id='dont' href='https://github.com/hifocus/adl'>GitHub</a>";
    ...
    document.getElementById("footer").innerHTML = "Version: " + version + " | Open Source Project on <a class='tooltip'id='dont' href='https://github.com/hifocus/adl'>GitHub</a>";
