...
if (typeof app_name_hk === 'undefined') {
    if (typeof app_name_cn !== 'undefined') {
        var app_name_hk = app_name_cn;
    }
    else {
        var app_name_hk = app_name;
    }
}
if (typeof app_name_cn === 'undefined') {
    var app_name_cn = app_name;
}
...
if (/zh-CN|zh-cn|zh-Hans|zh-hans|cn/i.test(userLang)) {
    document.title = "获取 " + app_name + " | ADL";
    document.getElementById("title").setAttribute("data-tooltip", "下载应用 于瞬息之间 ⚡");
    document.getElementById("docs").innerHTML = "使用文档";
    ...
    document.getElementById("footer").innerHTML = "<span class='smaller-fonts'>你的浏览器语言为 <code>" + userLang + "</code></span><br>版本: " + "<span class='grey'>" + version + " " + version_type +"</span> | 开源于 " + github_href;
    ...
    document.title = "獲取 " + app_name + " | ADL";
    ...
    document.getElementById("docs").innerHTML = "使用文檔";
    ...
    document.getElementById("footer").innerHTML = "<span class='smaller-fonts'>你的瀏覽器語言為 <code>" + userLang + "</code></span><br>版本: " + "<span class='grey'>" + version + " " + version_type +"</span> |  開源於 " + github_href;
    document.getElementById("dont").setAttribute("data-tooltip", "不要忘記 ⭐ 我們的項目");
}
else {
    document.title = "Get " + app_name + " | ADL";
    ...
    document.getElementById("footer").innerHTML = "<span class='smaller-fonts'>Your browser language is <code>" + userLang + "</code></span><br>Version: " + "<span class='grey'>" + version + " " + version_type + "</span> | Open Source Project on " + github_href;
